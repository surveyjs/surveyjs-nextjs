  ...
  return (
    <div className="flex min-h-screen flex-col items-center p-24">
      ...
      <div className="text-lg text-neutral-500 dark:text-neutral-300">
        ...
        <ul>
          <li><a style={{ textDecoration: "underline" }} href="https://surveyjs.io/Documentation/Library?id=LibraryOverview" target="_blank">SurveyJS Library / Runner</a></li>
          ...
          <li><a style={{ textDecoration: "underline" }} href="https://surveyjs.io/Documentation/Pdf-Export?id=PdfExportOverview" target="_blank">PDF Export</a></li>
          <li><a style={{ textDecoration: "underline" }} href="https://surveyjs.io/Documentation/Analytics?id=AnalyticsOverview" target="_blank">Survey Analytics</a></li>
        </ul>
      </div>
    </div>
  );
